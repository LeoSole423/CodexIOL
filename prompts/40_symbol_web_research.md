...
4. Solo despues consultar web externa (fuentes oficiales o primarias).
   - Politica por defecto: `strict_official_reuters`:
     - `source_tier=official` (issuer/regulador/filings).
     - `source_tier=reuters`.
   - No mezclar con blogs/medios no permitidos en modo estricto.
...
10. Checklist minimo por simbolo:
    ...
    - 1 fuente Reuters o primaria adicional de igual nivel
    - En `notes` JSON registrar:
      - `expert_name`
      - `org`
      - `source_tier`
